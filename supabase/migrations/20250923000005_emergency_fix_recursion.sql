...
-- Date: 2025-09-23
-- Purpose: Fix the immediate recursion issue by simplifying policies

-- =============================================
-- FIX BUDGET_PERIODS POLICIES (main culprit)
-- =============================================
...
BEGIN
  RAISE NOTICE '===========================================';
  RAISE NOTICE 'Emergency recursion fix applied!';
  RAISE NOTICE 'Fixed policies for:';
  RAISE NOTICE '- budget_periods';
  RAISE NOTICE '- budget_categories';
  RAISE NOTICE '- transactions';
  RAISE NOTICE 'Category updates should now work.';
  RAISE NOTICE '===========================================';
END $$;